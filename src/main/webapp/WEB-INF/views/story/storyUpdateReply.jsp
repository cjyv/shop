      ...
      <div id="header">
         <section class="h_inner">
            <div class="right_icons">
               <a href="${pageContext.request.contextPath}/story/story.reg.go">
                  <img
            ...
            <div class="contents_box">
               <article class="contents cont01">
                        ...
                        <div class="left_icons">
                           ...
                           <div>
                              <div class="count_likes">
                                 좋아요 <span class="count">${st.s_like_count }</span> 개
                              </div>
                  ...
                  <div class="detail--right_box">
                     ...
                     <form action="storyReply.update.do">
                           <div class="user_container-detail">
                              <div class="comment">
                                 <span class="user_id">${reply.sr_id}</span>
                                        <input value="${reply.sr_content }" name="sr_content">
                              <input value="${reply.sr_pk }" name="sr_pk" type="hidden">
                              <input value="${st.s_no }" name="s_no" type="hidden">
                     ...
                     <div class="commit_field">
                        ...
                        <form action="story.write.reply">
                           <input name="s_no" value="${st.s_no}" type="hidden"> <input
                              ...
                              type="text" placeholder="댓글달기.." name="sr_content">
